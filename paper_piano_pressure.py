...
# yellow line position ratio (relative to the entire frame height)
KEYBOARD_Y_RATIO = 0.44

# press threshold ratio (relative to the entire frame height)
PRESS_THRESHOLD_RATIO = 0.05  # 0.05 represents ±5% of the frame height

# keypoint IDs for fingertips (index, middle, ring, pinky)
FINGERTIP_IDS = [8, 12, 16, 20]  # index, middle, ring, pinky fingertip IDs
...
def main():
    ...
    with mp_hands.Hands(static_image_mode=False, max_num_hands=2, min_detection_confidence=0.6, min_tracking_confidence=0.6) as hands:
        while True:
            ...
            # use a yellow line to represent the keyboard position
            ...
            if results.multi_hand_landmarks:
                for hand_landmarks in results.multi_hand_landmarks:
                    ...
                    for tip_id in FINGERTIP_IDS:
                        ...
                        # calculate the relative height ratio of the fingertip to the yellow line
                        tip_y_ratio = py / h
            ...
            cv2.putText(frame, "close to yellow line, pressure triggered", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
